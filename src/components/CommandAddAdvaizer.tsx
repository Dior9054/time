...
export default function CommandAddAdvaizer() {
    return (
        <div>
                ...
                <div className="py-[36px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            <p className=" font-monserat font-[500] text-[18px] leading-[21px] text-[#434343]">Хронология Академ-Эдвайзеров</p>
                        </div>
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[50px] max-w-[18px] w-[100%]">№</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[94px] max-w-[320px] w-[100%] text-center">Название</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[122px] max-w-[360px] w-[100%] text-center">Период</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <div className="mr-[94px] max-w-[320px] w-[100%] flex items-center gap-[30px]">
                            ...
                            <div className="mr-[122px] max-w-[360px] w-[100%] flex items-center justify-center gap-[15px]">
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">C</p>
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">25/03/2024</p>
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">по</p>
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">Текущий</p>
                            </div>
            ...
            <div className="w-[100%] h-[max-content] mt-[32px] bg-[white] rounded-[10px] relative shadow-[0px_4px_4px_0px_#0000004D]">
                <div className="py-[36px]">
                    <div className="mx-[33px] flex items-center gap-[10px] cursor-pointer">
                        <svg width="20" height="16" viewBox="0 0 20 16">
                            <rect width="19.4978" height="16" transform="translate(0.0566406)" fill="white" />
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            <p className=" font-monserat font-[500] text-[18px] leading-[21px] text-[#434343]">Бизнес Эдвайзеры</p>
                        </div>
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[50px] max-w-[18px] w-[100%]">№</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[94px] max-w-[320px] w-[100%] text-center">Название</p>
