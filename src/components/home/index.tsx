...
export default function index() {
  return (
    <div className="px-[30px] pt-[80px] pb-[55px] w-[100%] h-[max-content]">
      <div className="bg-[white] rounded-[32px] w-[100%] h-[max-content] py-[36px]">
        ...
        <div className="rounded-[32px] h-[57px] border border-solid border-[#D9D9D9] mx-[33px] p-[9px] flex items-center gap-[8px] mt-[27px] mb-[35px]">
          <div className="h-[40px] rounded-[32px] border border-solid border-[#D9D9D9] w-[240px]">
          ...
          <div className="rounded-[32px] w-[164px] h-[35px] ml-auto bg-[#FFC300]">
            <Link to="/commandadd" className="w-[100%] h-[100%] py-[13px] px-[20px] rounded-[32px] font-monserat text-[white] font-[500] tracking-[0.75px] text-[12px] leading-[14px] flex items-center justify-center gap-[14px]">
        ...
        <div>
          <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[50px] min-w-[18px]">№</p>
            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[100px] min-w-[300px] text-center">Наименование</p>
            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[97px] min-w-[137px] text-center">Город</p>
            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] min-w-[137px] text-center">Университет</p>
          </div>
          <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[15px]">
            <p className="font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[50px] min-w-[18px]">1</p>
            <div className="mr-[100px] min-w-[300px] gap-[24px] flex items-center">
              <img src="/assets/img/nasa__image.png" className="w-[45px] h-[45px] rounded-[50%] object-cover cursor-pointer" />
              <p className="font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B]">Морских свинок</p>
            </div>
            <div className="min-w-[137px] flex justify-center mr-[97px]">
              <div className="min-w-[106px] min-h-[30px] bg-[#FFCAF4] rounded-[15px] flex items-center justify-center text-[#FF00CC] font-monserat font-[500] text-[12px] leading-[14px] cursor-pointer">Ош</div>
            </div>
            <p className="font-monserat font-[400] text-[13px] leading-[15px] text-[#464646] min-w-[137px] text-center">ОШГУ</p>
        ...
        <div className="flex items-center gap-[7px] mx-[32px] mt-[163px]">
