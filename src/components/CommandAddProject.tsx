...
export default function CommandAddProject() {
    return (
        <div>
                ...
                <div className="py-[36px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            ...
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[78px] max-w-[233px] w-[100%] text-center">Название</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[130px] max-w-[250px] w-[100%] text-center">Период</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[150px] w-[100%] text-center">Город</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <p className="mr-[78px] max-w-[233px] w-[100%] flex items-center gap-[30px] font-monserat font-[500] text-[13px] leading-[15px] text-[#000000]">Озеленение города</p>
                            <div className=" mr-[130px] max-w-[250px] w-[100%] flex items-center justify-center gap-[30px]">
                                ...
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">Активный</p>
                            </div>
                            <div className="min-w-[150px] flex justify-center mr-[36px]">
                                <div className="min-w-[100px] min-h-[30px] bg-[#FFCAF4] rounded-[15px] flex items-center justify-center text-[#FF00CC] font-monserat font-[500] text-[12px] leading-[14px] cursor-pointer">Ош</div>
                            </div>
