...
export default function Universiti() {
    return (
        <div className="py-[80px] px-[28px]">
            <div className="w-[100%] h-[max-content] bg-[white] rounded-[32px] relative shadow-[0px_4px_4px_0px_#0000004D]">
                <div className="py-[36px]">
                    ...
                    <div className="rounded-[32px] h-[57px] border border-solid border-[#D9D9D9] mx-[33px] p-[9px] flex items-center gap-[8px] mt-[27px] mb-[35px]">
                        ...
                        <div className="rounded-[32px] w-[164px] h-[35px] ml-auto bg-[#FFC300]">
                            <Link to="/universiti/add" className="w-[100%] h-[100%] py-[13px] px-[20px] rounded-[32px] font-monserat text-[white] font-[500] tracking-[0.75px] text-[12px] leading-[14px] flex items-center justify-center gap-[14px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            ...
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[20px] max-w-[447px] w-[100%] text-center">Наименование</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[97px] max-w-[117px] w-[100%] text-center">Город</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[233px] w-[100%] text-center">Ректор</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <div className=" mr-[20px] max-w-[447px] w-[100%] flex justify-start items-center gap-[25px]">
                                <img src="/assets/img/tak_prosto_logo.jpg" className="w-[45px] max-w-[45px] min-w-[45px] h-[45px] max-h-[45px] min-h-[45px]" />
                                <p className="font-monserat font-[500] text-[13px] leading-[15px] text-[#000000]">Ошский Государственный университет</p>
                            </div>
                            <div className="mr-[97px] max-w-[106px] w-[100%] text-center flex justify-center">
                                <div className="font-monserat font-[400] text-[12px] leading-[14px] text-[#FF00CC] h-[30px] bg-[#FFCAF4] flex items-center justify-center w-[100px] rounded-[15px]">Ош</div>
                            </div>
                            <p className=" font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] text-center max-w-[233px] w-[100%]">Кожобеков К. Г.</p>
