                ...
                <div className="py-[36px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            ...
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[78px] max-w-[233px] w-[100%] text-center">Наименование</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[74px] max-w-[253px] w-[100%] text-center">Период</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[43px] max-w-[116px] w-[100%] text-center">Город</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[137px] w-[100%] text-center">Заявки</p>
                        </div>
