...
export default function PersonalUserList() {
    return (
        <div className="w-[100%] h-[max-content] bg-[white] rounded-[10px]">
            <div className="py-[36px]">
                ...
                <div className="mb-[163px]">
                    <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                        <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[15px] max-w-[18px] w-[100%]">№</p>
                        <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[42px] max-w-[346px] w-[100%] text-center">Наименование</p>
                        <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[28px] max-w-[150px] w-[100%] text-center">Роль</p>
                        <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[144px] w-[100%] text-center">Команда</p>
                    </div>
