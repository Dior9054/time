...
export default function ProjectsApplication() {
    return (
        <div className="py-[32px] px-[28px]">
            <div className="flex items-center gap-[4px] mb-[37px] ml-[22px]">
                ...
                <p className=" font-monserat font-[500] text-[12px] leading-[14px] text-[#05070B]">Заявки по проекту “Проект 1”</p>
            </div>
            <div className="w-[100%] h-[max-content] bg-[white] rounded-[10px] relative shadow-[0px_4px_4px_0px_#0000004D]">
                <div className="py-[36px]">
                    ...
                    <div className="rounded-[32px] h-[57px] border border-solid border-[#D9D9D9] mx-[33px] p-[9px] flex items-center gap-[8px] mt-[27px] mb-[35px]">
                        ...
                        <div className="rounded-[32px] w-[164px] h-[35px] ml-auto bg-[#FFC300]">
                            <Link to="/projects/projectsadd" className="w-[100%] h-[100%] py-[13px] px-[20px] rounded-[32px] font-monserat text-[white] font-[500] tracking-[0.75px] text-[12px] leading-[14px] flex items-center justify-center gap-[14px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[57px] max-w-[18px] w-[100%]">№</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[184px] max-w-[280px] w-[100%] text-center">Наименование</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[97px] max-w-[136px] w-[100%] text-center">Город</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[117px] w-[100%] text-center">Пол</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] mr-[57px] max-w-[18px] w-[100%]">1</p>
                            <p className=" font-monserat font-[500] text-[13px] leading-[15px] text-[#000000] mr-[184px] max-w-[280px] w-[100%] text-start">Асанова Асана Асановна</p>
                            <div className="mr-[97px] max-w-[136px] w-[100%] text-center flex justify-center">
                                <div className=" font-monserat font-[500] text-[12px] leading-[14px] text-[#FF00CC] h-[30px] bg-[#FFCAF4] flex items-center justify-center w-[100px] rounded-[15px]">Ош</div>
                            </div>
                            <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] mr-[36px] max-w-[117px] w-[100%] text-center">Женщина</p>
                            <div className="relative ml-auto">
                                ...
                                >
                                    <>
                                        ...
                                        <Link to="/projects/application" className="flex items-center rounded-b-base_radius gap-3.5 py-3 px-4 border-b border-solid border-b-[#D6D6D6] cursor-pointer overflow-hidden bg-white hover:bg-base_yellow duration-100 hover:fill-white fill-[#464646] hover:text-white">
                                            <p className="font-monserat font-normal text-[12px] text-inherit">Заявки</p>
                                        </Link>
                                    </>
                                </ModalAlert>
                            </div>
                        ...
                        {/* <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <p className=" font-monserat font-[500] text-[13px] leading-[15px] text-[#000000] mr-[78px] max-w-[233px] w-[100%] text-start">Озеленение города</p>
                            <div className="mr-[74px] max-w-[253px] w-[100%] flex items-center justify-between">
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">24/03/2021</p>
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">по</p>
                                <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B]">24/03/2021</p>
                            </div>
                            <div className="mr-[43px] max-w-[116px] w-[100%] text-center flex justify-center">
                                <div className=" font-monserat font-[500] text-[12px] leading-[14px] text-[#FF00CC] h-[30px] bg-[#FFCAF4] flex items-center justify-center w-[100px] rounded-[15px]">Ош</div>
                            </div>
                            <p className="font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] mr-[36px] max-w-[137px] w-[100%] text-center">10</p>
                            <div className="relative ml-auto">
                                <ModalAlert
                                    width="w-[132px] border border-solid border-[#D6D6D6] rounded-[10px]"
                                    close={true}
