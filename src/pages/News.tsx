                ...
                <div className="py-[36px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            ...
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[97px] max-w-[350px] w-[100%] text-center">Название</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[20px] max-w-[234px] w-[100%] text-center">Категория</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[233px] w-[100%] text-center">Автор</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <p className=" font-monserat font-[500] text-[13px] leading-[15px] text-[#000000] mr-[50px] max-w-[447px] w-[100%] text-center">Конкурс на позицию медиа эксперта по проекту...</p>
                            <p className=" font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] mr-[20px] max-w-[234px] w-[100%] text-center">Конкурс</p>
