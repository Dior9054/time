                ...
                <div className="py-[36px]">
                    ...
                    <div className="rounded-[32px] h-[57px] border border-solid border-[#D9D9D9] mx-[33px] p-[9px] flex items-center gap-[8px] mt-[27px] mb-[35px]">
                        ...
                        <div className="rounded-[32px] w-[164px] h-[35px] ml-auto bg-[#FFC300]">
                            <Link to="/events/addevans" className="w-[100%] h-[100%] py-[13px] px-[20px] rounded-[32px] font-monserat text-[white] font-[500] tracking-[0.75px] text-[12px] leading-[14px] flex items-center justify-center gap-[14px]">
                    ...
                    <div className="mb-[163px]">
                        <div className="flex items-center min-h-[50px] border-y border-y-solid border-y-[#E8EAED] px-[15px] mb-[21px]">
                            ...
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[97px] max-w-[350px] w-[100%] text-center">Наименование</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[20px] max-w-[234px] w-[100%] text-center">Город</p>
                            <p className=" font-monserat font-[500] text-[15px] leading-[18px] text-[#05070B] mr-[36px] max-w-[233px] w-[100%] text-center">Дата</p>
                        </div>
                        <div className="flex items-center min-h-[60px] border-t border-t-solid border-t-[#E8EAED] px-[19px]">
                            ...
                            <p className=" font-monserat font-[500] text-[13px] leading-[15px] text-[#000000] mr-[50px] max-w-[447px] w-[100%] text-center">День Рождения Enactus</p>
                            <div className="mr-[20px] max-w-[234px] w-[100%] text-center flex justify-center">
                            ...
                            <p className=" font-monserat font-[400] text-[12px] leading-[14px] text-[#05070B] text-center max-w-[233px] w-[100%]">Асанов Асан</p>
